...
insert into Articulos(IdArticulo,Descripcion,IDFabrica,Color,Tamano,Modelo) values(01,'Lote 1',001,'Rojo','Grande',2012)

update Articulos set Color='Azul' where Color='Rojo'

delete from Articulos where IdArticulo = 01
