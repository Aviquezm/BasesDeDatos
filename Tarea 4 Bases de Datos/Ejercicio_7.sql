...
insert into DtosJugador(IdJugador,Email)
values('115-3953', 'Angelmadrizcr@gmail.com')
go

insert into DtosJugador(IdJugador,Email)
values('115-4353', 'Virginia@gmail.com')
go

UPDATE DtosJugador SET Email = 'VirginiaGamboaFonseca@gmail.com' WHERE IdJugador='115-4353';

DELETE FROM DtosJugador WHERE IdJugador = '115-3953';
