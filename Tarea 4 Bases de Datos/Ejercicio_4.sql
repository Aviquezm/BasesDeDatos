...
insert into Aeropuerto(IdAeropuerto,Nombre,Aterrizaje,Despeje)
values('0001', 'Angel Madriz Gamboa', 'San jose', 'Mexico DF' )
go

insert into Aeropuerto(IdAeropuerto,Nombre,Aterrizaje,Despeje)
values('0002', 'Elena Madriz Gamboa', 'San jose', 'Mexico DF' )
go

UPDATE Aeropuerto SET Aterrizaje = 'Panama' WHERE Nombre='Angel Madriz Gamboa';

DELETE FROM Aeropuerto WHERE Nombre = 'Elena Madriz Gamboa';
